...
namespace pkmn_ntr.Sub_forms
{
    public partial class Edit_Items : Form
    {
        ...
        public Edit_Items()
        {
            SAV = Program.gCmdWindow.SAV.Clone();
            InitializeComponent();
        ...
        private DataGridView GetDGV(InventoryPouch pouch)
        {
            ...
            string[] itemarr = Program.gCmdWindow.HaX ? (string[])itemlist.Clone() : GetItems(pouch.LegalItems);
        ...
        private void GetBags()
        {
            foreach (InventoryPouch pouch in Pouches)
            {
                ...
                if (!Program.gCmdWindow.HaX && incorrectPouch.Any())
                ...
                pouch.Sanitize(Program.gCmdWindow.HaX, itemlist.Length - 1);
                GetBag(dgv, pouch);
            }
        }
        ...
        private void SetBag(DataGridView dgv, InventoryPouch pouch)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                ...
                if (Program.gCmdWindow.HaX && SAV.Generation != 7) // Gen7 has true cap at 1023, keep 999 cap.
                {
        ...
        private void SwitchBag(object sender, EventArgs e)
        {
            ...
            if (disable && !Program.gCmdWindow.HaX)
            {
